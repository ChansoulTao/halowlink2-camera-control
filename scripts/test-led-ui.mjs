...
const E = (tag, attrs = {}, children = []) => ({ tag, attrs, children: Array.isArray(children) ? children : [children],
  value: attrs.value, disabled: !!attrs.disabled, textContent: typeof children === 'string' ? children : '' });
const injected = source.replace('return view.extend({', `
showCameraToast = () => {};
return { renderLEDBrightness: typeof renderLEDBrightness === 'function' ? renderLEDBrightness : undefined, busy: () => ledOperations };
view.extend({`);
